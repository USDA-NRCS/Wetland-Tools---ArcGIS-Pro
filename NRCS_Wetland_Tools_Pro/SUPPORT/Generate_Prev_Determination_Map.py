## ===============================================================================================================
## Name:    Generate Previous Determination Map
...
##
## rev. 07/15/2021
## -Start revisions from the Generate Determination Map tool to retool for the previous determinations map.
##
## ===============================================================================================================    
...
def logBasicSettings():
    ...
    f = open(textFilePath,'a+')
    f.write("\n######################################################################\n")
    f.write("Executing Generate Previous Determinations Map tool...\n")
...
try:
    ...
    showLocation = arcpy.GetParameter(1)
    plssPoint = arcpy.GetParameterAsText(2)
    owDetLayout = arcpy.GetParameter(3)
