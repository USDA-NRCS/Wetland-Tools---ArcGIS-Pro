...
def createCWD():
    ...
    arcpy.SetProgressorLabel("Removing old layers from database...")
...
##    toposToRemove = [cwdTopo]
    ...
    #Clip the SU layer copy by the request extent layer
    ...
    # Clip the SU layer copy by the New Request areas of the Request Extent layer
    ...
    arcpy.Clip_analysis(suTemp, extentTemp1, SU_Clip_Multi)
...
##                del workspace, edit
                ...
                arcpy.SetProgressorLabel("Revisions replacing all CWDs in the request extent...")
...
##                del workspace, edit
            ...
            arcpy.SetProgressorLabel("Changing Revisions to New Requests...")
...
##        del workspace, edit
    ...
    arcpy.SetProgressorLabel("Updating CWD attributes...")
