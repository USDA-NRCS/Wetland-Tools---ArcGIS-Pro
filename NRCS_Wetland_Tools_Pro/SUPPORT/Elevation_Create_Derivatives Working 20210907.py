...
try:
    ...
    inputDEMs = arcpy.GetParameterAsText(2).split(";")          # user selected input DEMs
    DEMcount = len(inputDEMs)
    zUnits = arcpy.GetParameterAsText(3)                        # elevation z units of input DEM
    interval = arcpy.GetParameterAsText(4)                      # user defined contour interval (string)
    demSR = arcpy.GetParameterAsText(5)
    cluSR = arcpy.GetParameterAsText(6)
    transform = arcpy.GetParameterAsText(7)
...
##            arcpy.CopyRaster_management(tempDEM2, tempDEM)
    ...
    arcpy.SetParameterAsText(8, projectContours)
    ...
    #arcpy.SetParameterAsText(9, projectSlope)
    arcpy.SetParameterAsText(10, projectDEM)
    arcpy.SetParameterAsText(11, projectHillshade)
    #arcpy.SetParameterAsText(12, projectDepths)
