from arcpy import AddError, AddMessage, Describe, GetParameterAsText, SetProgressorLabel
...
### Input Parameters ###
site_previous_clu_cwd_lyr = GetParameterAsText(0)
...
### Paths to Site GDB ###
site_cwd_lyr_path = Describe(site_previous_clu_cwd_lyr).CatalogPath
...
### Paths to Site Wetlands Folder for Output ###
...
for path in [cpa_028_wc_template_path, cpa_028_wc_supplemental_template_path, cpa_028_wc_definitions_template_path]:
...
SetProgressorLabel('Reading Admin Table data...')
...
AddMessage('Finished generating 028 form, opening in Microsoft Word...')
